			...
			<div className="fm-list">
				...
				<div className="fm-list-body">
					<div className="fm-list-item">
						...
						<Checkbox type="radio" style={{marginLeft: "15px"}} name="sex" checkboxVal="2"
						          label="女"></Checkbox>
						<Checkbox style={{marginLeft: "15px"}} name="sex" checkboxVal="3" disabled={true}
						          checked={true} label="不可选"></Checkbox>
					</div>
				</div>
				<div className="fm-list-header">
					单选按钮CheckboxItem（年龄）
				...
				<div className="fm-list-body">
					...
					<CheckboxItem name="ball" type="checkbox" checkboxVal="4" content="橄榄球(默认选中)" disabled={true}
					              checked={true}></CheckboxItem>
				</div>
				<div className="fm-list-header">
					协议勾选
				</div>
